...
python -m multi_start.problems.sgd_specific_function $rs 1 100 0.0 0.1 1 $lr real_gradient $problem 1
python -m multi_start.problems.sgd_specific_function $rs 1 100 0.0 0.1 1 $lr grad_epoch $problem 1
