...
if __name__ == '__main__':
    # python -m multi_start.script_run_hutter_policy 1 20 0.1 0.1 100 problem5
    ...
    for i in range(n_restarts):
        ...
        results = SGD(start, gradient, batch_size, objective, maxepoch=n_epochs, adam=False,
                      ...
                      std, random_seed, lb, ub, lr, 'hutter', i),
                      exact_gradient=None, learning_rate=lr, method=method, n_epochs=5,
    ...
    policy_greedy = HutterGreedyPolicy(stat_models, 'hutter', problem_name, random_seed=random_seed, n_restarts=n_restarts)
