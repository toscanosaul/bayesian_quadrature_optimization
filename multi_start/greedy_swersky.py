...
class SwerskyGreedy(object):

    def __init__(self, dict_stat_models, name_model, problem_name, type_model='swersky', epsilon=0.1, total_iterations=100,
    ...
    def get_parameters(self):
        for index in self.dict_stat_models:
            ...
            params = model.compute_posterior_params_marginalize(n_samples=self.n_samples)
    ...
    def save_data(self, sufix=None):
        ...
        file_name += 'swersky_greedy_policy/'
